            ...
            if str(tv_id) == str(request.POST.get('tv')):
                ...
                if tv_status == 0: #check ping response
                    ...
                    if form.is_valid(): 
                        ...
                        form.save()
                        print("saved")
                        src = r"C:/Users/a.shahbaaz/Desktop/Django Project/bctc2/BCTC/media/videos/" + TVName + r".mp4"
                        dst = r"C:/Users/a.shahbaaz/Desktop/Django Project/bctc2/BCTC/media/RemoteVideos/" + TVName + r".mp4"
